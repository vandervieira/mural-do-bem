...
--
CREATE DATABASE IF NOT EXISTS `muraldobem` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `muraldobem`;
...
(1, 'Primeiro Usuario', 'primeiro@usuario.com', '$2a$10$ttVx7JTejoGblFnlIVPRcuaZG80UQdwlkttxdGU0YPF6MWI0iU.02', '/public/defaults/avatar.jpg'),
(2, 'Segundo Usuario', 'segundo@usuario.com', '$2a$10$TpoMJn.dKnt.ghSBSkMbu.chsciXY3HL.YOrj1i7rVVFVhxfDOFNe', '/public/defaults/avatar.jpg'),
(3, 'Terceiro Usuario', 'terceiro@usuario.com', '$2a$10$Me9ubcmcajJmxaVfHNSpqe.1iJJVn4zbhBS/3EiCzkzkxdfGg.tnK', '/public/defaults/avatar.jpg'),
(4, 'Quarto Usuario', 'quarto@usuario.com', '$2a$10$Ggj9aKv/7TYalZynu2FNue/Z2/yNvCC05UGyqPbHwiI3MMENtipgq', '/public/defaults/avatar.jpg');
